"""
Implementations of the Concordance Correlation Coeficient:
...
# From: https://github.com/stylianos-kampakis/supervisedPCA-Python/blob/master/Untitled.py
def concordance_correlation_coefficient_python(y_true, y_pred,
                       sample_weight=None,
